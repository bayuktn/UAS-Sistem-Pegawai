...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">Sistem Pegawai</a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('image/pic1.png')}}" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Yahya Dipraja</p>
          <p class="app-sidebar__user-designation">UI UX Designer</p>
        </div>
      </div>
      <ul class="app-menu">
